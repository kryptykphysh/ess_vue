class MachineStatusesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @machine_status.save
        ...
        format.json { render :show, status: :created, location: @machine_status }
      else
  ...
  def update
    respond_to do |format|
      if @machine_status.update(machine_status_params)
        ...
        format.json { render :show, status: :ok, location: @machine_status }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to machine_statuses_url, notice: 'Machine status was successfully destroyed.' }
  ...
  private
    ...
    def machine_status_params
      params.require(:machine_status).permit(:machine_id, :status_id, :first_logged_at, :last_logged_at)
    end
end
